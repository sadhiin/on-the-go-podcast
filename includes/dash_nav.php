...
<header class="header" id="header">
    ...
    <!-- <button class="navbar-brand brand" onclick="location.href='./app.onthegopodcast.php'">Back to Home</button> -->
    <a class="btn btn-primary" href="./app.onthegopodcast.php" role="button">Back to home</a>
    <!-- </div> -->
</header>
